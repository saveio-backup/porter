...
func (*ID) Descriptor() ([]byte, []int) {
	return fileDescriptor_stream_a539c2dffdf20c1e, []int{0}
}
...
func (*Message) Descriptor() ([]byte, []int) {
	return fileDescriptor_stream_a539c2dffdf20c1e, []int{1}
}
...
func (*Ping) Descriptor() ([]byte, []int) {
	return fileDescriptor_stream_a539c2dffdf20c1e, []int{2}
}
...
func (*Pong) Descriptor() ([]byte, []int) {
	return fileDescriptor_stream_a539c2dffdf20c1e, []int{3}
}
...
func (*LookupNodeRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_stream_a539c2dffdf20c1e, []int{4}
}
...
func (*LookupNodeResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_stream_a539c2dffdf20c1e, []int{5}
}
...
func (*Bytes) Descriptor() ([]byte, []int) {
	return fileDescriptor_stream_a539c2dffdf20c1e, []int{6}
}
...
func (*Keepalive) Descriptor() ([]byte, []int) {
	return fileDescriptor_stream_a539c2dffdf20c1e, []int{7}
}
...
func (*KeepaliveResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_stream_a539c2dffdf20c1e, []int{8}
}
...
func (*Disconnect) Descriptor() ([]byte, []int) {
	return fileDescriptor_stream_a539c2dffdf20c1e, []int{9}
}
...
func (*ProxyRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_stream_a539c2dffdf20c1e, []int{10}
}
...
func (*ProxyResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_stream_a539c2dffdf20c1e, []int{11}
}
...
func (*MetricRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_stream_a539c2dffdf20c1e, []int{12}
}
...
func (*MetricResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_stream_a539c2dffdf20c1e, []int{13}
}
...
func (m *MetricRequest) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalTo(dAtA)
	if err != nil {
...
func (m *MetricRequest) MarshalTo(dAtA []byte) (int, error) {
	var i int
	_ = i
	var l int
	_ = l
	if m.SendTimestamp != 0 {
		dAtA[i] = 0x8
		i++
		i = encodeVarintStream(dAtA, i, uint64(m.SendTimestamp))
	}
	if len(m.RawData) > 0 {
		dAtA[i] = 0x12
		i++
		i = encodeVarintStream(dAtA, i, uint64(len(m.RawData)))
...
func (m *MetricResponse) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalTo(dAtA)
	if err != nil {
...
func (m *MetricResponse) MarshalTo(dAtA []byte) (int, error) {
	var i int
	_ = i
	var l int
	_ = l
...
func (m *MetricRequest) Size() (n int) {
	var l int
	_ = l
	if m.SendTimestamp != 0 {
		n += 1 + sovStream(uint64(m.SendTimestamp))
	}
	l = len(m.RawData)
	if l > 0 {
		n += 1 + l + sovStream(uint64(l))
...
func (m *MetricResponse) Size() (n int) {
	var l int
	_ = l
	if m.SendTimestamp != 0 {
		n += 1 + sovStream(uint64(m.SendTimestamp))
...
func (m *MetricRequest) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: MetricRequest: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: MetricRequest: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 0 {
...
func (m *MetricResponse) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: MetricResponse: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: MetricResponse: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 0 {
...
func init() { proto.RegisterFile("stream.proto", fileDescriptor_stream_a539c2dffdf20c1e) }

var fileDescriptor_stream_a539c2dffdf20c1e = []byte{
	// 512 bytes of a gzipped FileDescriptorProto
	,
}
